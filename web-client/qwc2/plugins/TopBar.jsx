...
class TopBar extends React.Component {
  ...
  render() {
    ...
    if (this.props.logoUrl) {
      logoEl = (
        <a href={this.props.logoUrl} rel="noreferrer" target="_blank">
          {logoEl}
        </a>
      );
    }
      ...
      >
        <div className={classes} id="TopBar" ref={this.storeHeight}>
          ...
          <div className="center-span">
            {this.props.components.Search ? <this.props.components.Search searchOptions={searchOptions} /> : null}
            {this.props.components.Toolbar ? (
              <this.props.components.Toolbar openExternalUrl={this.openUrl} toolbarItems={this.props.toolbarItems} />
            ) : null}
          </div>
          ...
          {this.props.components.FullscreenSwitcher ? <this.props.components.FullscreenSwitcher /> : null}
        </div>
      </Swipeable>
    );
  }
