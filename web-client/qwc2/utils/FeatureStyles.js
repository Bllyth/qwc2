    ...
    return [
      ...
      new ol.style.Style({
        ...
        text: new ol.style.Text({
          ...
          textAlign: feature.getGeometry() && feature.getGeometry().getType() === "Point" ? "left" : "center",
          textBaseline: feature.getGeometry() && feature.getGeometry().getType() === "Point" ? "bottom" : "middle",
          offsetX: feature.getGeometry() && feature.getGeometry().getType() === "Point" ? 5 + opts.circleRadius : 0,
        }),
      }),
    ];
  },
